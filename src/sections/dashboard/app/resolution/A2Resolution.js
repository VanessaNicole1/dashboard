    ...
    <Card sx={{ maxWidth: 900 }}>
      <CardContent>
        ...
        >
          ...
          se asignará la carga horaria de acuerdo a lo establecido. Las
          evidencias del cumplimiento de esta actividad podrán ser: las técnicas
          planificadas para el desarrollo del proceso enseñanza-aprendizaje, las
          presentaciones, videos, guías para el desarrollo de las actividades de
          aprendizaje, reportes del EVA u otros recursos metodológicos que
          prepare el docente para el desarrollo de la asignatura.
        </Typography>
      </CardContent>
    </Card>
  );
